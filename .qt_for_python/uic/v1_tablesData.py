...
class Ui_tablesData(object):
    def setupUi(self, tablesData):
        ...
        self.tableLesRepresentations.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableLesRepresentations.setHorizontalHeaderItem(4, item)
        self.tableLesRepresentations.horizontalHeader().setDefaultSectionSize(190)
